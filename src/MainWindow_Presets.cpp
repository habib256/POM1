...
MainWindow_ImGui::windowRegistry()
{
    ...
    static const std::vector<WindowDescriptor> kReg = {
        ...
        { "TutorialMicroSD",      "Tutorial: microSD",                         &MW::showTutorialMicroSD,    K::Tutorial,    true  , &MW::renderTutorialMicroSDWindow },
        { "TutorialCassette",     "Tutorial: Cassette (ACI)",                  &MW::showTutorialCassette,   K::Tutorial,    true  , &MW::renderTutorialCassetteWindow },
        { "TutorialModemBBS",     "Tutorial: Wi-Fi Modem BBS",                 &MW::showTutorialModemBBS,   K::Tutorial,    true  , &MW::renderTutorialModemBBSWindow },
        { "TutorialGT6144",       "Tutorial: SWTPC GT-6144",                   &MW::showTutorialGT6144,     K::Tutorial,    true  , &MW::renderTutorialGT6144Window },
        { "TutorialIECCard",      "Tutorial: IEC",                             &MW::showTutorialIECCard,    K::Tutorial,    true  , &MW::renderTutorialIECCardWindow },
        { "TutorialPR40",         "Tutorial: SWTPC PR-40 Printer",             &MW::showTutorialPR40,       K::Tutorial,    true  , &MW::renderTutorialPR40Window },
        { "TutorialTMS9918",      "Tutorial: P-LAB TMS9918",                   &MW::showTutorialTMS9918,    K::Tutorial,    true  , &MW::renderTutorialTMS9918Window },
        { "TutorialA1IORTC",      "Tutorial: P-LAB A1-IO & RTC",               &MW::showTutorialA1IORTC,    K::Tutorial,    true  , &MW::renderTutorialA1IORTCWindow },
        { "TutorialSID",          "Tutorial: A1-SID / A1-AUDIO SE",            &MW::showTutorialSID,        K::Tutorial,    true  , &MW::renderTutorialSIDWindow },
        { "TutorialGEN2HGR",      "Tutorial: Uncle Bernie's GEN2 HGR",         &MW::showTutorialGEN2HGR,    K::Tutorial,    true  , &MW::renderTutorialGEN2HGRWindow },
        { "TutorialCFFA1",        "Tutorial: CFFA1 CompactFlash",              &MW::showTutorialCFFA1,      K::Tutorial,    true  , &MW::renderTutorialCFFA1Window },
        { "TutorialJukeBox",      "Tutorial: P-LAB Juke-Box",                  &MW::showTutorialJukeBox,    K::Tutorial,    true  , &MW::renderTutorialJukeBoxWindow },
        { "TutorialTerminalCard", "Tutorial: P-LAB Terminal Card",             &MW::showTutorialTerminalCard, K::Tutorial,  true , &MW::renderTutorialTerminalCardWindow },
        { "TutorialKrusader",     "Tutorial: Krusader",                        &MW::showTutorialKrusader,   K::Tutorial,    true  , &MW::renderTutorialKrusaderWindow },
        // ── Info / credits / photos ───────────────────────────────────────────────────────────────────────────────────────────
        { "About",                "About POM1",                                &MW::showAbout,              K::Info,        true  , &MW::renderAboutDialog },
        ...
        { "KeyboardPhoto",        "Apple-1 ASCII Keyboard",                    &MW::showKeyboardPhoto,      K::Peripheral,  true  , &MW::renderKeyboardPhotoWindow },
